...
local success, result = pcall(function()
    if readfile and isfile and isfile(Linux.ConfigFolder .. "/autoload.json") then
...
local success, result = pcall(function()
    if readfile and isfile and isfile(Linux.ConfigFolder .. "/privacy.json") then
...
local success, result = pcall(function()
    if readfile and isfile and isfile(Linux.ConfigFolder .. "/" .. name .. ".json") then
...
local success, result = pcall(function()
    if delfile and isfile and isfile(Linux.ConfigFolder .. "/" .. name .. ".json") then
...
Linux.SavedConfigs = {}
local success, result = pcall(function()
    if listfiles and isfolder and isfolder(Linux.ConfigFolder) then
...
if config.ConfigSave ~= false then
    ...
    local privacyToggle = SettingsTab.Toggle({
        ...
        Callback = function(state)
            ...
            if PlayerDisplayName and PlayerRealName then
                if state then
